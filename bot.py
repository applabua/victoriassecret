...
# Новый порядок – после удаления 3-го (Toasted Amber) из исходного списка.
# Порядок картинок (изначальные ссылки):
# 1: https://i.ibb.co/9k8BmxSN/photo-2025-04-15-16-46-14.jpg
# 2: https://i.ibb.co/5X6nDCq4/photo-2025-04-15-16-46-15.jpg
# 3: https://i.ibb.co/qYHnDZrx/photo-2025-04-15-16-46-13.jpg  --> удалён
# 4: https://i.ibb.co/r2wmHsqT/photo-2025-04-15-15-08-33.jpg
# 5: https://i.ibb.co/1Y98rzQ6/photo-2025-04-15-15-08-27.jpg
# 6: https://i.ibb.co/p6rpLtys/photo-2025-04-15-15-08-22-2.jpg
# 7: https://i.ibb.co/wZKsPN71/photo-2025-04-15-15-08-22.jpg
# 8: https://i.ibb.co/HL97djJX/photo-2025-04-15-15-08-21-2.jpg
# 9: https://i.ibb.co/bRdsf7wN/photo-2025-04-15-15-08-21.jpg
# 10: https://i.ibb.co/sdDmQmqN/photo-2025-04-15-15-08-20-2.jpg
# 11: https://i.ibb.co/KcNhVvK4/photo-2025-04-15-15-08-20.jpg
# 12: https://i.ibb.co/Mx9J3CYN/photo-2025-04-15-15-08-19.jpg
# 13: https://i.ibb.co/r2J0CXgm/photo-2025-04-15-15-08-18-2.jpg
# 14: https://i.ibb.co/cXtXDGWC/photo-2025-04-15-15-08-18.jpg
# 15: https://i.ibb.co/1Y98rzQ6/photo-2025-04-15-15-08-17.jpg
# 16: https://i.ibb.co/KcGGjcHs/photo-2025-04-15-15-12-19-2.jpg
# 17: https://i.ibb.co/4whM3CBj/photo-2025-04-15-15-12-19.jpg
# 18: https://i.ibb.co/ccfr76k4/photo-2025-04-15-15-12-18-2.jpg
# 19: https://i.ibb.co/0yJxwb5b/photo-2025-04-15-15-12-18.jpg
# 20: https://i.ibb.co/qvTCHVV/photo-2025-04-15-15-12-17.jpg
# 21: https://i.ibb.co/nMb7BfJb/photo-2025-04-15-15-12-16-2.jpg
# 22: https://i.ibb.co/bMcQSsLv/photo-2025-04-15-15-12-16.jpg
# 23: https://i.ibb.co/N2rqMnHr/photo-2025-04-15-15-12-15.jpg
products = {
    "1": {
    ...
    "14": {
        ...
        "image": "https://i.ibb.co/1Y98rzQ6/photo-2025-04-15-15-08-17.jpg"
    },
    "15": {
    ...
    "19": {
        "name": "19. Velvet Petals Bliss 💗",
        "description": (
            "Ніжний, витончений аромат, який огортає мов м’який шарф. Квіткові ноти із солодким кремовим відтінком створюють справжню насолоду.\n"
    ...
    "20": {
        "name": "20. Aqua Kiss 🌊🌸",
        "description": (
            "Неймовірно свіжа квіткова симфонія! Фрезія та маргаритка створюють чистий, легкий аромат — дихання весни на тілі.\n"
    ...
    "21": {
        ...
        "description": (
            "Справжня класика спокуси! Соковита слива та квіткова свіжість зливаються в яскравий, романтичний аромат, який не забувається.\n"
    ...
    "22": {
        ...
        "description": (
            "Легендарний аромат тепла й ніжності. М’яка ваніль із натяком на кремовий кашемір створює враження солодкого обійму.\n"
...
def start_command(update: Update, context: CallbackContext) -> int:
    ...
    welcome_text = (
        ...
        "Наші аромати допоможуть вам відчути справжню красу та догляд, який ви заслуговуєте.\n\n"
...
def page_handler(update: Update, context: CallbackContext) -> int:
    """
    Обрабатывает нажатия навигационных кнопок (формат "PAGE_<номер>") и обновляет меню товаров.
    """
...
def back_to_menu_handler(update: Update, context: CallbackContext) -> int:
    ...
    welcome_text = (
        "🌟 Ласкаво просимо до Victoria's Secret! 🌟\n\n"
        "Відкрийте для себе розкішний асортимент оригінальних парфумованих лосьйонів та кремів з США. "
        "Наші аромати допоможуть вам відчути справжню красу та догляд!\n\n"
        "Оберіть свій ідеальний товар нижче:"
    )
    welcome_image = "https://i.ibb.co/cS9WCwrJ/photo-2025-04-14-01-23-29.jpg"
    context.bot.send_photo(
...
def order_product(update: Update, context: CallbackContext) -> int:
    """
    При выборе товара "Замовити 🛍" запрашивает у пользователя номер телефона и имя.
    """
    query = update.callback_query
    query.answer()
    data = query.data
...
def get_phone_name(update: Update, context: CallbackContext) -> int:
    """
    Сохраняет номер телефона та ім'я, затем запрашивает адрес доставки.
    """
