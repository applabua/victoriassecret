...
# Номера записаны обычными цифрами, а возле названия добавлен один соответствующий смайлик.
products = {
    "1": {
    ...
    "12": {
        "name": "12. Pure Seduction Daydream 🍭🌸",
        "description": (
    ...
    "22": {
        ...
        "description": (
            "Справжня класика спокуси — аромат, в якому соковита слива та квіткова свіжість зливаються в яскраву романтичну композицію.\n\n"
            "🔹 Ноти: стигла слива, пелюстки фрезії"
        ),
        "image": "https://i.ibb.co/bMcQSsLv/photo-2025-04-15-15-12-16.jpg"
    },
    "23": {
        "name": "23. Bare Vanilla Classic 🍦🌰",
        "description": (
            "Легендарний аромат тепла та ніжності. М’яка ваніль із натяком на кремовий кашемір створює враження солодкого обійму.\n\n"
